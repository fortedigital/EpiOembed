...
using EpiserverPlayground.Models.Pages;
...
namespace EpiserverPlayground.Models.ViewModels
{
    public class FindSearchContentModel : PageViewModel<FindSearchPage>
    {
        ...
        {
            return UriUtil.AddQueryString(RemoveQueryStringByKey(HttpContext.Current.Request.Url.AbsoluteUri,"p"), "t", HttpContext.Current.Server.UrlEncode(groupName));
        }
